...
const statusFromString = Array.from("Active");
console.log('status from string: ' + statusFromString);

// alphabetical sorting of array
const alphabeticallySortedStatuses = [...statuses].sort((a,b) => a.localeCompare(b));
console.log('Alphabetically sorted statuses: ' + alphabeticallySortedStatuses);

// alphabetical sorting of array in reverse order
const reversAlphabeticallySortedStatuses = [...statuses].sort((a,b) => b.localeCompare(a));
console.log('Reverse alphabetically sorted statuses: ' + reversAlphabeticallySortedStatuses);
